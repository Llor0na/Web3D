...
Cette initiative constitue une base pour explorer davantage la récupération de models 3D sur le web, en prenant en compte les particularités de chaque source de données.
