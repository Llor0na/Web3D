...
Nous cherchons à extraire des données du fichier mview à l'intérieur du visualiseur. Notre point de départ idéal est de repérer les requêtes réseau, car le fichier mview est chargé par le visualiseur via une fonction JavaScript appelée XMLHttpRequest.
